(module
 ...
 (data (i32.const 1244) " ")
 (data (i32.const 1254) "\f0?\00\00\00\00\00\00\00@\00\00\00\00\00\00\08@\00\00\00\00\00\00\10@")
 (data (i32.const 1292) "\1c\00\00\00\01")
 (data (i32.const 1324) "<\00\00\00\01")
 (data (i32.const 1340) " ")
 (data (i32.const 1350) "\14@\00\00\00\00\00\00\18@\00\00\00\00\00\00\1c@")
 ...
 (data (i32.const 1488) "\06\00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00\"\1a\00\00\00\00\00\00\"\t")
 ...
 (export "getSize" (func $assembly/index/getSize))
 (export "getSum" (func $assembly/index/getSum))
 ...
 (func $assembly/index/MatrixXd#constructor@varargs (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $assembly/index/getSize (result i32)
  global.get $assembly/index/m1
  i32.load
  i32.load offset=12
 )
 ...
 (func $assembly/index/MatrixXd#__add (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $assembly/index/getSum (result f64)
  (local $0 i32)
  (local $1 i32)
  (local $2 f64)
  (local $3 i32)
  ...
  call $assembly/index/MatrixXd#__add
  local.tee $3
  call $~lib/rt/pure/__retain
  local.tee $4
  local.set $1
     ...
     block $invalid
      block $assembly/index/MatrixXd
       block $~lib/arraybuffer/ArrayBufferView
        ...
        i32.sub
        i32.load
        br_table $__inlined_func$~lib/rt/__visit_members $__inlined_func$~lib/rt/__visit_members $~lib/arraybuffer/ArrayBufferView $assembly/index/MatrixXd $folding-inner1 $folding-inner1 $invalid
       end
       local.get $2
       i32.load
       local.tee $1
